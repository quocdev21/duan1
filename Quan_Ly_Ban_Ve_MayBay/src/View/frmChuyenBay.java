...
public class frmChuyenBay extends javax.swing.JFrame {
    ...
    private void cbx_TuyenBay() {
        ...
        try {
            int cao = 3;
            ArrayList<TuyenBay> arr_TB = new ChuyenBayRepo().layDS_TB();
    ...
    private void cbx_MayBay() {
        ...
        try {
            int cao = 3;
            ArrayList<MayBay> arr_MB = new ChuyenBayRepo().layDS_MB();
    ...
    private void bang() {
        new ChuyenBayRepo().loadTable(tblChuyenBay);
    }
    ...
    private void them() {
        if (check()) {
            ...
            int kt = new ChuyenBayRepo().them(new ChuyenBay(macb, ngaydi, ngayden, gio, Integer.parseInt(thuongia), Integer.parseInt(phothong), tuyenbay, maybay));
            if (kt == 1) {
                bang();
                ChuyenBay hk = new ChuyenBayRepo().timCBToDen(macb);
    ...
    private void capNhat() {
        if (!txtMaChuyenBay.getText().isEmpty()) {
            ...
            String tuyenbay = txtMaTuyenBay.getText().trim();
            String maybay = txtMaMayBay.getText().trim();
            int kt = new ChuyenBayRepo().sua(new ChuyenBay(macb, ngaydi, ngayden, gio, Integer.parseInt(thuongia), Integer.parseInt(phothong), tuyenbay, maybay));
            if (kt == 1) {
                bang();
    ...
    private void xoa() {
        if (dong >= 0) {
            ...
            if (r == JOptionPane.YES_OPTION) {
                String macb = txtMaChuyenBay.getText().trim();
                int kt = new ChuyenBayRepo().xoa(new ChuyenBay(macb));
                if (kt == 1) {
                    bang();
                } else {
    ...
    private void hienThi(int row) {
        ...
        new ChuyenBayRepo().hienThi(tblChuyenBay, cb, row);
    ...
    private void txtTimKiemKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtTimKiemKeyReleased
        new ChuyenBayRepo().tim(tblChuyenBay, txtTimKiem.getText().trim());
        editColumnWidth();
