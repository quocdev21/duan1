...
import Repository.DoanhThuTheoThangRepo;
...
public class frmDoanhThuTheoThang extends javax.swing.JFrame {
    ...
    void loadTable_DoanhThu() {
        try {
            ...
            new DoanhThuTheoThangRepo().loadTable_DoanhThu(tblDoanhThuThang, quy, nam);
    ...
    void loadSLVe() {
        ...
        int s1 = new DoanhThuTheoThangRepo().getSL_Ve(quy, nam, "HV01", "lV01");
        int s2 = new DoanhThuTheoThangRepo().getSL_Ve(quy, nam, "HV01", "lV02");
        int s3 = new DoanhThuTheoThangRepo().getSL_Ve(quy, nam, "HV02", "lV01");
        int s4 = new DoanhThuTheoThangRepo().getSL_Ve(quy, nam, "HV02", "lV02");
    ...
    void in_ThongKe() {
        ...
        int tongTien = new DoanhThuTheoThangRepo().getTongTien(quy, nam);
        new DoanhThuTheoThangRepo().in_ThongKe(quy, nam, tongTien);
    }
