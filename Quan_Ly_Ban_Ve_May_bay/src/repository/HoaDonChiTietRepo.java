 ...
 * @author TuanDuc
 */
public class HoaDonChiTietRepo extends getConnection {
        ...
        try {
            ...
            for (int i = 0; i < model.getRowCount(); i++) {
                ...
                if (hangVe.equals("HV01") && loaiVe.equals("LV01")) {
                    ...
                    model.setValueAt(donGia * 1.1 * 1.9 + new DichVuRepo().getTienDV(maVe), i, 4);
                } else if (hangVe.equals("HV02") && loaiVe.equals("LV02")) {
                    model.setValueAt(donGia * 1.1 + new DichVuRepo().getTienDV(maVe), i, 4);
                }
            }
            for (int i = 0; i < model.getRowCount(); i++) {
